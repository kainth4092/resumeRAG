            ...
            <div className="p-10 space-y-4">
                ...
                {summaryText && (
                    <div className="space-y-1">
                        <h2 className="text-[11px] font-bold uppercase tracking-wider border-b border-black pb-0.5">Professional Summary</h2>
                ...
                {experienceList.length > 0 && (
                    <div className="space-y-3">
                        <h2 className="text-[11px] font-bold uppercase tracking-wider border-b border-black pb-0.5">Professional Experience</h2>
                        <div className="space-y-3">
                            {experienceList.map((e) => (
                                <div key={e.id} className="space-y-0.5">
                                    <div className="flex justify-between items-baseline font-bold">
                                        <span>
                                            {e.company}{e.location ? `, ${e.location}` : ""} — <span className="font-normal italic">{e.role}</span>
                                        </span>
                                    ...
                                    <ul className="list-disc pl-5 space-y-0.5">
                                        {e.bullets?.filter(Boolean).map((bullet, i) => (
                                            <li key={i} className="text-justify text-gray-950 leading-normal">
                                                {bullet}
                                            </li>
                                        ))}
                                    </ul>
                ...
                {projectsList.length > 0 && (
                    <div className="space-y-2">
                        <h2 className="text-[11px] font-bold uppercase tracking-wider border-b border-black pb-0.5">Academic & Personal Projects</h2>
                        <div className="space-y-2">
                            {projectsList.map((p) => (
                                <div key={p.id} className="space-y-0.5">
                                    <div className="flex justify-between items-baseline font-bold">
                                        ...
                                        {p.url && <span className="text-[9.5px] font-normal italic">{p.url}</span>}
                                    </div>
                                    {p.desc && (
                                        <ul className="list-disc pl-5 space-y-0.5">
                ...
                {educationList.length > 0 && (
                    <div className="space-y-2">
                        <h2 className="text-[11px] font-bold uppercase tracking-wider border-b border-black pb-0.5">Education</h2>
