import { Briefcase, CheckCircle2, FileText, Star, TrendingUp, Zap } from "lucide-react";
...
const DEFAULT_ACTIVITIES = [
    { icon: Zap, color: "text-primary bg-primary/10", title: "Welcome to ResumeRAG", body: "Upload or generate your first resume to get started!", time: "Just now" }
];
...
export const statCards = [
    { label: "ATS Average Score", value: 88, suffix: "", unit: "/100", delta: "+6 pts", positive: true, icon: Star, color: "text-primary", bg: "bg-primary/10", route: "/resumes" },
