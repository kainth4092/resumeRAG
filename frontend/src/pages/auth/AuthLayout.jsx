...
export function AuthLayout({
    ...
    return (
        <div className="bg-background flex" style={{ minHeight: "calc(105vh - 28px)" }}>
            ...
            <div className="hidden lg:flex lg:w-[52%] xl:w-[55%] relative overflow-hidden flex-col">
                ...
                <div className="relative flex-1 flex flex-col px-12 py-10 z-10">
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <span className="text-white font-semibold text-md leading-none block">ResumeRAG AI</span>
                            <span className="text-violet-300 text-xs tracking-widest uppercase">Powered by AI</span>
                        </div>
                    </div>
                    ...
                    <div className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-2 leading-snug">{leftTitle}</h2>
                        <p className="text-violet-200/80 text-sm leading-relaxed max-w-xs">{leftSubtitle}</p>
                    </div>
                        ...
                        <div className="bg-white/8 border border-white/15 rounded-2xl p-4 backdrop-blur-sm">
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-violet-200/60">{testimonial.role}</p>
                                </div>
                            </div>
                        </div>
                    )} */}
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 overflow-y-auto">
                ...
                <div className="lg:hidden flex items-center gap-2 mb-8">
                    ...
                    <span className="font-semibold text-foreground">ResumeRAG AI</span>
                </div>
