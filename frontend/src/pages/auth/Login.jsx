...
export default function Login({ onNavigate }) {
    ...
    return (
        <AuthLayout
            ...
            leftSubtitle="ResumeRAG AI analyzes job descriptions and tailors your resume to maximize ATS scores and recruiter attention."
        // testimonial={{
        ...
        >
            <div className="space-y-7">
                <div>
                    <h1 className="justify-center text-2xl font-semibold text-foreground tracking-tight">Welcome back</h1>
                    <p className="text-muted-foreground text-sm mt-1.5">Sign in to your ResumeRAG AI account</p>
                </div>
