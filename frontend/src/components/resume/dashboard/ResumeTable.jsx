    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-end p-4">
          <div
            className="bg-card border border-border rounded-3xl w-full max-w-sm overflow-hidden shadow-[var(--shadow-xl)] animate-in fade-in zoom-in-95 duration-200 text-left"
            ref={menuRef}
          >
