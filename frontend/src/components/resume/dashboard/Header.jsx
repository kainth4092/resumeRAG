...
export default function Header({ resumes = [], onNewResume }) {
  ...
  return (
    <div className="flex items-start justify-between gap-4 font-sans">
      ...
      <button
        onClick={onNewResume}
        className="flex items-center gap-2 px-4 py-2.5 bg-primary text-white rounded-xl hover:bg-primary/90 active:scale-[0.98] transition-all shadow-sm shadow-primary/20 text-sm font-semibold flex-shrink-0 cursor-pointer"
      >
