    ...
    <div className="bg-card border border-border rounded-2xl p-5 shadow-[var(--shadow-sm)]">
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 h-11 px-5 rounded-2xl bg-primary text-white text-sm font-bold hover:bg-primary/90 active:scale-[0.98] disabled:opacity-70 transition-all shadow-sm shadow-primary/20 flex-shrink-0 cursor-pointer"
        >
          {loading ? (
