  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-lg bg-card border border-border rounded-2xl shadow-[var(--shadow-lg)] p-6 animate-in fade-in-0 zoom-in-95 duration-200 space-y-4">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Sample Answer</label>
            <textarea
              required
              value={formData.answer}
              onChange={(e) => setFormData({ ...formData, answer: e.target.value })}
              placeholder="Provide a clear, detailed sample answer..."
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-9 px-3 text-sm bg-input-background border border-border rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary/25 transition-all"
              >
                <option value="Fresher">Fresher (Easy)</option>
                <option value="1-3 Years">1-3 Years (Medium)</option>
                <option value="3-5 Years">3-5 Years (Hard)</option>
              </select>
            </div>
